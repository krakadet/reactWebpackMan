...
//
// function newInputValue(state = {}, action) {
//   switch (action.type) {
//     default:
...
//   combineReducers({ user, newInputValue }),
//   {
//     user: { name: '12', surname: '123', checkboxes: [] },
//     newInputValue: { profile: { name: 'profile', surname: '123', checkboxes: [] } },
//   },
//   window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__(),
// );
// /* eslint-enable */
//
// export default connect(mapStateToProps, formActions, mergeActionsToProps)(Example);
//
//
